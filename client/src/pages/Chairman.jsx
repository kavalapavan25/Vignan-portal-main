...
const Chairman = () => {
  return (
    <div>
      <h1 className="text-4xl font-bold text-center my-8">Chairman's Message</h1>
      <div className="container mx-auto p-8 flex flex-col md:flex-row items-center">
        <img src="https://via.placeholder.com/150" alt="Chairman" className="rounded-full h-48 w-48 mb-8 md:mb-0 md:mr-8" />
        <div>
          <h2 className="text-3xl font-bold">Dr. Lavu Rathaiah</h2>
          <p className="text-xl text-gray-600">Chairman</p>
